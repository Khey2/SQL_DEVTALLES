...
('NLD', 'Netherlands', 'Europe', 'Western Europe', 41526, 1581, 15864000, 78.3, 371362.00, 360478.00, 'Nederland', 'Constitutional Monarchy', 'Beatrix', 5, 'NA'),
...
('DZA', 'Algeria', 'Africa', 'Northern Africa', 2.381741e+06, 1962, 31471000, 69.7, 49982.00, 46966.00, 'Al-Jaza�ir/Alg�rie', 'Republic', 'Abdelaziz Bouteflika', 35, 'DZ'),
...
('AZE', 'Azerbaijan', 'Asia', 'Middle East', 86600, 1991, 7734000, 62.9, 4127.00, 4100.00, 'Az�rbaycan', 'Federal Republic', 'Heyd�r �liyev', 144, 'AZ'),
...
('BEN', 'Benin', 'Africa', 'Western Africa', 112622, 1960, 6097000, 50.2, 2357.00, 2141.00, 'B�nin', 'Republic', 'Mathieu K�r�kou', 187, 'BJ'),
...
('CRI', 'Costa Rica', 'North America', 'Central America', 51100, 1821, 4023000, 75.8, 10226.00, 9757.00, 'Costa Rica', 'Republic', 'Miguel �ngel Rodr�guez Echeverr�a', 584, 'CR'),
...
('DOM', 'Dominican Republic', 'North America', 'Caribbean', 48511, 1844, 8495000, 73.2, 15846.00, 15076.00, 'Rep�blica Dominicana', 'Republic', 'Hip�lito Mej�a Dom�nguez', 587, 'DO'),
...
('SLV', 'El Salvador', 'North America', 'Central America', 21041, 1841, 6276000, 69.7, 11863.00, 11203.00, 'El Salvador', 'Republic', 'Francisco Guillermo Flores P�rez', 645, 'SV'),
...
('FRO', 'Faroe Islands', 'Europe', 'Nordic Countries', 1399, NULL, 43000, 78.4, 0.00, NULL, 'F�royar', 'Part of Denmark', 'Margrethe II', 901, 'FO'),
...
('GRL', 'Greenland', 'North America', 'North America', 2.16609e+06, NULL, 56000, 68.1, 0.00, NULL, 'Kalaallit Nunaat/Gr�nland', 'Part of Denmark', 'Margrethe II', 917, 'GL'),
...
('GIN', 'Guinea', 'Africa', 'Western Africa', 245857, 1958, 7430000, 45.6, 2352.00, 2383.00, 'Guin�e', 'Republic', 'Lansana Cont�', 926, 'GN'),
...
('HTI', 'Haiti', 'North America', 'Caribbean', 27750, 1804, 8222000, 49.2, 3459.00, 3107.00, 'Ha�ti/Dayti', 'Republic', 'Jean-Bertrand Aristide', 929, 'HT'),
...
('ISL', 'Iceland', 'Europe', 'Nordic Countries', 103000, 1944, 279000, 79.4, 8255.00, 7474.00, '�sland', 'Republic', '�lafur Ragnar Gr�msson', 1449, 'IS'),
...
('CPV', 'Cape Verde', 'Africa', 'Western Africa', 4033, 1975, 428000, 68.9, 435.00, 420.00, 'Cabo Verde', 'Republic', 'Ant�nio Mascarenhas Monteiro', 1859, 'CV'),
...
('COD', 'Congo, The Democratic Republic of the', 'Africa', 'Central Africa', 2.344858e+06, 1960, 51654000, 48.8, 6964.00, 2474.00, 'R�publique D�mocratique du Congo', 'Republic', 'Joseph Kabila', 2298, 'CD'),
...
('CYP', 'Cyprus', 'Asia', 'Middle East', 9251, 1960, 754700, 76.7, 9333.00, 8246.00, 'K�pros/Kibris', 'Republic', 'Glafkos Klerides', 2430, 'CY'),
...
('LUX', 'Luxembourg', 'Europe', 'Western Europe', 2586, 1867, 435700, 77.1, 16321.00, 15519.00, 'Luxembourg/L�tzebuerg', 'Constitutional Monarchy', 'Henri', 2452, 'LU'),
...
('MEX', 'Mexico', 'North America', 'Central America', 1.958201e+06, 1810, 98881000, 71.5, 414972.00, 401461.00, 'M�xico', 'Federal Republic', 'Vicente Fox Quesada', 2515, 'MX'),
...
('NIC', 'Nicaragua', 'North America', 'Central America', 130000, 1838, 5074000, 68.7, 1988.00, 2023.00, 'Nicaragua', 'Republic', 'Arnoldo Alem�n Lacayo', 2734, 'NI'),
...
('CIV', 'C�te d�Ivoire', 'Africa', 'Western Africa', 322463, 1960, 14786000, 45.2, 11345.00, 10285.00, 'C�te d�Ivoire', 'Republic', 'Laurent Gbagbo', 2814, 'CI'),
...
('GUF', 'French Guiana', 'South America', 'South America', 90000, NULL, 181000, 76.1, 681.00, NULL, 'Guyane fran�aise', 'Overseas Department of France', 'Jacques Chirac', 3014, 'GF'),
('PYF', 'French Polynesia', 'Oceania', 'Polynesia', 4000, NULL, 235000, 74.8, 818.00, 781.00, 'Polyn�sie fran�aise', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3016, 'PF'),
('REU', 'R�union', 'Africa', 'Eastern Africa', 2510, NULL, 699000, 72.7, 8287.00, 7988.00, 'R�union', 'Overseas Department of France', 'Jacques Chirac', 3017, 'RE'),
('ROM', 'Romania', 'Europe', 'Eastern Europe', 238391, 1878, 22455500, 69.9, 38158.00, 34843.00, 'Rom�nia', 'Republic', 'Ion Iliescu', 3018, 'RO'),
...
('STP', 'Sao Tome and Principe', 'Africa', 'Central Africa', 964, 1975, 147000, 65.3, 6.00, NULL, 'S�o Tom� e Pr�ncipe', 'Republic', 'Miguel Trovoada', 3172, 'ST'),
...
('SEN', 'Senegal', 'Africa', 'Western Africa', 196722, 1960, 9481000, 62.2, 4787.00, 4542.00, 'S�n�gal/Sounougal', 'Republic', 'Abdoulaye Wade', 3198, 'SN'),
...
('TJK', 'Tajikistan', 'Asia', 'Southern and Central Asia', 143100, 1991, 6188000, 64.1, 1990.00, 1056.00, 'To�ikiston', 'Republic', 'Emomali Rahmonov', 3261, 'TJ'),
...
('TGO', 'Togo', 'Africa', 'Western Africa', 56785, 1960, 4629000, 54.7, 1449.00, 1400.00, 'Togo', 'Republic', 'Gnassingb� Eyad�ma', 3332, 'TG'),
...
('TCD', 'Chad', 'Africa', 'Central Africa', 1.284e+06, 1960, 7651000, 50.5, 1208.00, 1102.00, 'Tchad/Tshad', 'Republic', 'Idriss D�by', 3337, 'TD'),
...
('TKM', 'Turkmenistan', 'Asia', 'Southern and Central Asia', 488100, 1991, 4459000, 60.9, 4397.00, 2000.00, 'T�rkmenostan', 'Republic', 'Saparmurad Nijazov', 3419, 'TM'),
...
('HUN', 'Hungary', 'Europe', 'Eastern Europe', 93030, 1918, 10043200, 71.4, 48267.00, 45914.00, 'Magyarorsz�g', 'Republic', 'Ferenc M�dl', 3483, 'HU'),
...
('NCL', 'New Caledonia', 'Oceania', 'Melanesia', 18575, NULL, 214000, 72.8, 3563.00, NULL, 'Nouvelle-Cal�donie', 'Nonmetropolitan Territory of France', 'Jacques Chirac', 3493, 'NC'),
...
('VNM', 'Vietnam', 'Asia', 'Southeast Asia', 331689, 1945, 79832000, 69.3, 21929.00, 22834.00, 'Vi�t Nam', 'Socialistic Republic', 'Tr�n Duc Luong', 3770, 'VN'),
